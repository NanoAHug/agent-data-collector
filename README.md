...
2. **Web Authentication**: Web interface uses password login with Session Cookie to maintain login state
...
DATA_COLLECTION_API_KEY = "your_api_key"  # Generated by generate_token.py
```
